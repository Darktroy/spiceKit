...
@extends('companyadminpanel.header')
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">SpiceKitchen Admin Panel</a>
...
<!--        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href={{route("menu_items.menu_items.index")}}>Menu </a>
        ...
        <li class="nav-item">
          <a class="nav-link" href={{route("menu_items.menu_items.index")}}>
            <i class="fas fa-fw fa-anchor"></i>
            <span>Menus</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href={{route("galleries.gallery.index")}}>
            <i class="fas fa-fw fa-anchor"></i>
            <span>Gallery</span></a>
        </li>
        <li class="nav-item">
